...
{
	$labels = [
		"name" => esc_html__("journal", "custom-post-type-ui"),
		"singular_name" => esc_html__("journal entry", "custom-post-type-ui"),
	];

	$args = [
		"label" => esc_html__("Journal", "custom-post-type-ui"),
		"labels" => $labels,
		"description" => "",
		"public" => true,
		"publicly_queryable" => true,
		...
		"supports" => ["title", "editor", "thumbnail", "excerpt", "trackbacks", "custom-fields", "revisions"],
		"taxonomies" => ["category", "post_tag"], // journal用のカテゴリとタグを指定
		"show_in_graphql" => false,
	];
