...
<main>
	...
	<section class="work">
		...
		$concepts = nl2br(get_post_meta($post_id, 'concepts', true));
		$points = nl2br(get_post_meta($post_id, 'points', true));
		...
		<div class="work__content ">
			...
			<div class="work__content-left">
				...
				<div class="work__content-concepts content">
					...
					<p class="content-text"><?= $concepts; ?></p>
				</div>
